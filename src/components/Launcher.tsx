...
import { AlertTriangle, Car, Clapperboard, Crosshair, Eye, FolderOpen, Gamepad2, Gauge, Mountain, PersonStanding, Plus, RotateCcw, Sparkles, Sprout, X } from 'lucide-react';
